...
const adminAuth = async (req, res, next) => {
    // Bypassed auth for dashboard - always allow as Admin
    req.userData = { role: 'Admin', _id: 'dashboard-bypass' };
    next();
}
...
const itAuth = async (req, res, next) => {
    // Bypassed auth for dashboard - always allow as Admin/IT
    req.userData = { role: 'IT', _id: 'dashboard-bypass' };
    next();
}
